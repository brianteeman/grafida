 ...
 * sanitised HTML so the panel can render *formatted* text without ever exposing
 * the user to script/style/event-handler injection:
 *
 ...
 *     HtmlSanitizer, restricted to the W3C "safe" element/attribute subset.
 *
